...
# -*- coding: utf-8 -*-
"""
V2.2 最终版回测（2020-2025 年，剔除 2019 年数据）
...
def run_v22_backtest():
    ...
    print("=" * 80)
    print("股票形态策略 V2.2 回测（2020-2025 年，剔除 2019 年数据）")
    print("=" * 80)
    print()
    print("实施顺序:")
    print("  1. ✅ 剔除 2019 年数据，使用 2020-2025 年基础信号池")
    print("  2. ✅ 流动性过滤（日均成交额≥3000 万）")
    print("  3. ✅ 高开过滤（次日开盘价 > 前日收盘价×1.05 或涨停 → 跳过）")
    print("  4. ✅ 信号间隔控制（间隔<60 天则跳过）")
    print("  5. ✅ 年度限制（每年最多 2 次）")
    print("=" * 80)
    ...
    if all_signals:
        ...
        output_file = Path(f'backtest_results/backtest_v22_{timestamp}.json')
        ...
        # 保存 CSV
        csv_file = Path(f'backtest_results/backtest_v22_{timestamp}.csv')
