...
class BacktesterV22:
    ...
    def __init__(self, config_path: str = 'config_v21_final.yaml'):
        ...
        # V2.2 新增：放宽缩量到放量的时间窗口
        self.shrink_to_surge_days = pattern_config.get('shrink_to_surge_days', 25)  # V2.2: 25 天
    ...
    def _detect_pattern_from_start(self, period_df: pd.DataFrame, code: str) -> Optional[Dict]:
        ...
        # 2. 检测缩量（V2.2: 在放量日前 25 天内，原来是 10 天）
        shrink_found = False
        shrink_idx = -1
