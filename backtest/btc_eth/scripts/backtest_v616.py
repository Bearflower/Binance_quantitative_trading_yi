...
class BacktestEngine:
    ...
    def _check_and_open_position(
        ...
        if atr_percent < 1.0 or atr_percent > 7.0:
        ...
        # 5. 成交量放大过滤（v6.16：S≥1.5，A≥1.5，B/C不要求）
...
### 止盈止损参数
- 止损：1.8×ATR（从2.0×ATR收紧）
- TP1：3.5×ATR（平25%，从3.0×ATR提高）
- TP2：6.0×ATR（平25%，从4.5×ATR提高）
- 吊灯启动：2.0×ATR（从2.5×ATR提前）
- 吊灯回撤：1.5×ATR（从1.8×ATR收紧）
- 时间止损：48小时未达TP1平仓50%（从72小时缩短）
