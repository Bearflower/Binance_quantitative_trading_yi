...
class BacktestEngine:
    ...
    def __init__(self, config: Dict):
        ...
        self.filter_stats = {
            ...
            'low_volatility_filtered': 0,  # 低波动市场过滤（v6.16.3新增）
            'opened_positions': 0,
    ...
    def _check_and_open_position(
        ...
        # 确定等级（v6.16.3：B级阈值提高到70）
        if score >= 85:
            grade = 'S'
        elif score >= 75:
            grade = 'A'
        elif score >= 70:  # v6.16.3修改：从65提高到70
            grade = 'B'
        else:
            grade = 'C'
