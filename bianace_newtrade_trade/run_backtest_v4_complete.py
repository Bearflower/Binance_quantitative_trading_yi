    ...
    def run_backtest(self, data_file: str, output_file: str):
        ...
        for symbol, symbol_data in symbols_data.items():
            ...
            for i in range(10, min(len(klines_1h), 100)):
                ...
                print(f"  ✅ 开仓 @ {entry_price:.6f}, 评分={total_score:.2f}")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='V4.0 完整回测')
    parser.add_argument('--data', type=str, default='data/2025_new_coins_data.json')
    parser.add_argument('--output', type=str, default='data/backtest_v4_complete.json')

    args = parser.parse_args()

    backtester = CompleteBacktesterV4()
