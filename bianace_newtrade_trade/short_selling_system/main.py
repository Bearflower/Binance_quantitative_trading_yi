...
from core.scoring_engine import ScoringEngine, scoring_engine
...
def monitor_new_coins_task(detector, scoring_engine, pattern_recognition, signal_manager, real_data):
    """
    监控新币任务
    """
    try:
...
def start_monitoring():
    """启动监控服务"""
    logger.info("🚀 启动币安新币精准做空系统")
    
    detector, scoring_engine, pattern_recognition, signal_manager, scheduler = init_system()
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='币安新币精准做空系统')
