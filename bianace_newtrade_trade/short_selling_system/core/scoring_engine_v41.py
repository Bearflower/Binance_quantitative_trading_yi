...
class ScoringResultV41:
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> 'ScoringResultV41':
        """从字典创建评分结果"""
        return cls(
            symbol=data['symbol'],
...
scoring_engine_v41 = ScoringEngineV41()
